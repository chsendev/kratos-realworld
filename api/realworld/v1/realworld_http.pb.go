...
type RealworldHTTPClient interface {
	...
	GetCurrentUser(ctx context.Context, req *GetCurrentUserRequest, opts ...http.CallOption) (rsp *UsersReply, err error)
	...
	Login(ctx context.Context, req *LoginRequest, opts ...http.CallOption) (rsp *UsersReply, err error)
	Register(ctx context.Context, req *RegisterRequest, opts ...http.CallOption) (rsp *UsersReply, err error)
	...
	UpdateUser(ctx context.Context, req *UpdateUserRequest, opts ...http.CallOption) (rsp *UsersReply, err error)
}
...
func (c *RealworldHTTPClientImpl) GetCurrentUser(ctx context.Context, in *GetCurrentUserRequest, opts ...http.CallOption) (*UsersReply, error) {
	var out UsersReply
	pattern := "/api/user"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *RealworldHTTPClientImpl) Login(ctx context.Context, in *LoginRequest, opts ...http.CallOption) (*UsersReply, error) {
	var out UsersReply
...
func (c *RealworldHTTPClientImpl) Register(ctx context.Context, in *RegisterRequest, opts ...http.CallOption) (*UsersReply, error) {
	var out UsersReply
	pattern := "/api/users"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *RealworldHTTPClientImpl) UpdateUser(ctx context.Context, in *UpdateUserRequest, opts ...http.CallOption) (*UsersReply, error) {
	var out UsersReply
	pattern := "/api/user"
	path := binding.EncodeURL(pattern, in, false)
